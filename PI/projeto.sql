...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/03/2025 às 21:31
...
--
ALTER TABLE `categoria`
  MODIFY `id_cat` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `produto`
  MODIFY `id_prod` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

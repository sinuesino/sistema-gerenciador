...
<div class="bemvindo"><h2>Exluir produto</h2></div>
        ...
        <div class="row">
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach ($produtos as $produto) {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="tabeladedeleteprod.php" method="POST">
              ...
              if (isset($_POST['id_prod']) && isset($_POST['deletar'])) {
                  ...
                  echo "<div class='alert alert-danger'>ID do produto não especificado ou botão de exclusão não pressionado.</div>";
              }
              ?>
